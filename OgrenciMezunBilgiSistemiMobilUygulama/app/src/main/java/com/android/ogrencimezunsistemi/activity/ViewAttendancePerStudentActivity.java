...
public class ViewAttendancePerStudentActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		attendanceList.add("Öğrenci Başına Mevcut Sayı");
		...
		/*listView.setOnItemLongClickListener(new OnItemLongClickListener() {
			...
			public boolean onItemLongClick(AdapterView<?> arg0, View arg1,
				...
				alertDialogBuilder.setTitle(getTitle()+"  Sil");
				...
				alertDialogBuilder.setPositiveButton("Evet",new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog,int id) {
						...
						{
							String users = " Adı: " + facultyBean.getFaculty_firstname()+"\Soyadı:"+facultyBean.getFaculty_lastname();
							facultyList.add(users);
							Log.d("Kullanıcılar: ", users);
				...
				alertDialogBuilder.setNegativeButton("Hayır",new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog,int id) {
						...
						dialog.cancel();
						Toast.makeText(getApplicationContext(), "İptal edildi",
