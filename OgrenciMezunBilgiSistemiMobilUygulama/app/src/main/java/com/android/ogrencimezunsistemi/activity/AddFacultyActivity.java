		...
		registerButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (TextUtils.isEmpty(first_name)) {
					textFirstName.setError("Lütfen isim giriniz");
				}
				else if (TextUtils.isEmpty(last_name)) {
					textLastName.setError("Lütfen soyisim giriniz");
				}
				else if (TextUtils.isEmpty(phone_no)) {
					textcontact.setError("Lütfen telefon numarası giriniz");
				}

				else if (TextUtils.isEmpty(address)) {
					textaddress.setError("Lütfen adres giriniz");
				}	
				else if (TextUtils.isEmpty(userName)) {
					textcontact.setError("Lütfen kullanıcıadı giriniz");
				}
				else if (TextUtils.isEmpty(passWord)) {
					textaddress.setError("Lütfen şifre giriniz");
				}				
				else { 
					...
					Toast.makeText(getApplicationContext(), "Kullanıcı başarıyla kaydoldu", Toast.LENGTH_SHORT).show();
