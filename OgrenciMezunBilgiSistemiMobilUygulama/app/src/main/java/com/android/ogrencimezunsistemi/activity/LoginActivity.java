...
public class LoginActivity extends Activity {
	...
	String userrole;
	private String[] userRoleString = new String[] { "yönetici", "fakülte"};
		...
		login.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(userrole.equals("yönetici"))
				{
					...
					{
						username.setError("Geçersiz Kullanıcı Adı");
					}
					...
					{
						if(user_name.equals("yönetici") & pass_word.equals("yönetici123")){
